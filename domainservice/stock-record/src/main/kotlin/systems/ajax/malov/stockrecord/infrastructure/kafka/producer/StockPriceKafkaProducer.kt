package systems.ajax.malov.stockrecord.infrastructure.kafka.producer
...
import systems.ajax.malov.stockrecord.application.port.out.StockPriceProducerOutPort
import systems.ajax.malov.stockrecord.domain.StockRecord
import systems.ajax.malov.stockrecord.infrastructure.kafka.mapper.StockRecordMapper.toStockPrice

@Component
class StockPriceKafkaProducer(
    private val kafkaPublisher: KafkaPublisher,
) : StockPriceProducerOutPort {
